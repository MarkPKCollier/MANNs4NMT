...
Result = collections.namedtuple('Result', (
    'read_content_keys', 'read_content_strengths', 'write_content_keys', 'write_content_strengths', 'write_vectors',
    'erase_vectors', 'free_gate', 'allocation_gate', 'write_gate', 'read_mode'))
